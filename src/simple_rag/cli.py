...
from .mcp_server import PROJECT_ROOT, run_mcp_server
...
def build_parser() -> argparse.ArgumentParser:
    ...
    mcp = subparsers.add_parser("mcp-server", help="Start an MCP server for simpleRAG")
    mcp.add_argument(
        "--transport",
        default="stdio",
    ...
    mcp.add_argument("--name", default="simple-rag", help="MCP server name")
